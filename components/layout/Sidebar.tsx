    ...
    <div className="flex flex-col h-full bg-slate-900 border-r border-slate-800">
      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b border-slate-800">
        ...
        <div className="min-w-0">
          <p className="text-sm font-semibold text-white truncate">Container Tracking</p>
          <p className="text-xs text-slate-500 truncate">Manajemen Kontainer</p>
        </div>
        {onClose && (
            ...
            return (
              <div key={item.label}>
                ...
                >
                  ...
                  <svg className={cn("w-4 h-4 transition-transform flex-shrink-0", isOpen && "rotate-90")}
                      ...
                      <Link key={child.href} href={child.href} onClick={onClose}
                        className={cn("block px-3 py-2 rounded-lg text-sm transition-colors",
                          pathname.startsWith(child.href)
                            ? "text-white bg-brand-700/50 font-medium"
