...
export const blocksApi = {
  ...
  getOccupiedSlots: (blockId: number) => api.get<{ data: { registration_id: number; pos_length: number; pos_width: number; pos_height: number }[] }>(`/master/blocks/${blockId}/occupied-slots`),
